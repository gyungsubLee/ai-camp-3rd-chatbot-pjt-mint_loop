...
### **3.2 RecommendationAgent - 여행지 추천 + SSE 스트리밍**
...
graph TB
    subgraph Frontend["Frontend (Next.js 14)"]
        UI[App Router Pages]
        API_PROXY[API Routes Proxy]
        ZUSTAND[Zustand State<br/>useChatStore<br/>useVibeStore]
    end
    ...
    subgraph External["External Services"]
        ...
        MCP_SEARCH[Search MCP<br/>:8050]
        MCP_PLACES[Places MCP<br/>:8052]
    end

    UI --> API_PROXY
    API_PROXY --> API_SERVER
    UI --> ZUSTAND
